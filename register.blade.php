...
<form method="POST" action="/store">  //This page if for Customer Registration
    <h4 style="font-size:20px; color: #3498db; font-family: Arial, sans-serif;">Hello Mam/Sir Welcome to our Page<h4>
